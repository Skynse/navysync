...
class _CalendarPageState extends ConsumerState<CalendarPage> {
  ...
  bool _isEventInCurrentMonth(DateTime eventDate, DateTime displayDate) {
    return eventDate.year == displayDate.year &&
              ...
              Expanded(
                child: Container(
                  ...
                  child: SfCalendar(
                    ...
                    firstDayOfWeek:
                        1, // Start week on Monday (1 = Monday, 7 = Sunday)
                    headerDateFormat:
                        'MMMM yyyy', // Month format for month view
                    headerHeight: 60,
                    showNavigationArrow: true,
                    showDatePickerButton: false, // Disable date picker button
                    allowViewNavigation:
                        false, // Prevent unwanted view navigation
                    ...
                    monthViewSettings: MonthViewSettings(
                      ...
                      showTrailingAndLeadingDates:
                          true, // Show trailing/leading dates
                      showAgenda: true,
                    ...
                    appointmentBuilder: (context, details) {
                      ...
                      final currentDisplayDate =
                          _calendarController?.displayDate ?? DateTime.now();
                      final isCurrentMonth = _isEventInCurrentMonth(
                        eventDate,
                        currentDisplayDate,
                      );
                      ...
                      return FutureBuilder<String?>(
                        future: _getUserAttendanceStatus(
                          appointment.subject,
                          events,
                        ),
                        builder: (context, snapshot) {
                          ...
                          return Container(
                            width:
                                ...
                                0.95, // Month view: nearly full width
                            height:
                                details.bounds.height *
                                0.6, // Month view: shorter height for better centering
                            margin: const EdgeInsets.symmetric(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  (!isCurrentMonth)
                                      ? appointment.color.withOpacity(
                                        0.3,
                                      ) // Lighter color for adjacent month events
                                      : appointment
                                          .color, // Full color for current month
                              borderRadius: BorderRadius.circular(4),
                              border:
                                  (!isCurrentMonth)
                                      ? Border.all(
                                        color: appointment.color.withOpacity(
                                          0.5,
                                        ),
                                        width: 1,
                              ...
                              ListTile(
                                ...
                                onTap: () async {
                                  final picked = await showDatePicker(
                                    ...
                                    firstDate: DateTime(
                                      2020,
                                    ), // Allow selecting dates from 2020
  ...
  Future<String?> _getUserAttendanceStatus(
    String eventTitle,
    List<Event> events,
  ) async {
    try {
